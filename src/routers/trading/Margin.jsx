...
import TradeHistory from "../../components/trading/margin/TradeHistory";
...
import Order from "../../components/trading/margin/Order";
...
export default function Margin() {
  ...
  const [actCategory, setActCateogry] = useState("Order");
        ...
        <section className="innerBox">
          ...
          <article className="actArea">
            <ul className="actCategoryList">
              <li className={`${actCategory === "Order" && "on"}`}>
                <button onClick={() => setActCateogry("Order")}>
                  <p>Order</p>
                </button>
              </li>
            ...
            <div className="contBox">
              {actCategory === "Order" && <Order symbol={symbol}/>}
