...
import { D_listCategoryList, D_spotCategoryList, D_spotSymbolList } from "../../data/D_trading";
...
import OrderHistory from "../../components/trading/spot/OrderHistory";

export default function Spot() {
  const [btmCategory, setBtmCateogry] = useState(D_spotCategoryList[0]);
      ...
      <SpotBox>
        <section className="innerBox">
          <article className="leftArea">
              ...
              <div className="topBar">
                <div className="tokenBox">
                  <button className="selBtn" onClick={() => setSymbolListPopup(!symbolListPopup)} >
                    ...
                    <strong>{symbol.marketSymbol}</strong>
                    <img className="arw" src={I_dnPolWhite} alt="" />
                  </button>
                  {symbolListPopup && (
                    <>
                      <SelSymbolListPopup off={setSymbolListPopup} list={D_spotSymbolList} setCont={setSymbol}/>
            ...
            <div className="bottomBox">
              ...
              <div className="contBox">
                {btmCategory === "Open Orders" && <Orders symbol={symbol.marketSymbol}/>}
                {btmCategory === "Order History" && <OrderHistory/>}
          ...
          <article className="listArea">
            ...
            {listCategory === D_listCategoryList[0] && <Book symbol={symbol.marketSymbol}/>}
          ...
          <article className="actArea">
            ...
            <div className="contBox">
              {actCategory === "Market" && <Market symbol={symbol.assetSymbol}/>}
              {actCategory === "Limit" && <Limit symbol={symbol.assetSymbol}/>}
