...
export default function WithdrawPopup({ off, nextCont }) {
  ...
  return (
    <WithdrawPopupBox className="defaultPopup">
      ...
      <article className="contArea">
        <ul className="setList">
          ...
          <li className="addrBox">
            ...
            <div className="value">
              <div className="inputBox">
              0xcc3114f5376061c3baDa3744E39EA2584D971B19
              {/* <input
                type="text"
                dir="ltr"
                  onChange={() => {}}
...
const WithdrawPopupBox = styled.section`
  width: 472px;
